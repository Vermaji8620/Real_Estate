...
const UpdateListing = () => {
  ...
  // useffect k andar me sirf ye krrhe hai ki,  pura page ek baar bs call ho , loading k time pe,  jissse ki apne aap form ka andar already jo data loaded hai(database me) wo put ho jaye....aur iske liye inbuilt-params hook ka use krnge---
  useEffect(() => {
    (async () => {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="3xl font-semibold text-center my-7">Update a Listing</h1>
